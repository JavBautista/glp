        ...
        <div class="col-md-8">
	        ...
	        <form method="post" action="/admin/customers/update">
				...
				<div class="form-group row">
				    ...
				    <div class="col-sm-10">
				      <input type="text" class="form-control @if($errors->has('mail')) is-invalid @endif" id="mail" name="mail" value="{{ old('mail',$customer->mail) }}" placeholder="email@example.com" required>
				      @if($errors->has('mail'))
