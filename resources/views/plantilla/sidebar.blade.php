<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
             <a href="/admin/collectors" class="nav-link"><i class="icon-people"></i>Recolectores</a>
            </li>
            <li class="nav-item">
             <a href="/admin/customers" class="nav-link"><i class="icon-notebook"></i>Clientes</a>
            </li>
            <li class="nav-item">
             <a href="/admin/shipments" class="nav-link"><i class="fa fa-truck"></i>Envios</a>


<!--
            <li class="nav-item nav-dropdown">
                <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-bag"></i> Inicio</a>
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" href="/"><i class="icon-bag"></i> Tiendas</a>
                    </li>
                    <li class="nav-item">
