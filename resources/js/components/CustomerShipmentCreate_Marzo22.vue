            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group row mt-2">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" v-model="remitent_mail" placeholder="email@example.com">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" v-model="remitent_company" placeholder="Mi Negocio">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" v-model="remitent_name" placeholder="Mr. Juan Valdez" required>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" v-model="remitent_rfc" placeholder="RFC o Razon Social">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" v-model="remitent_phone" placeholder="7775985421" required>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" v-model="remitent_movil" placeholder="7775985421" required>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" v-model="remitent_zip_code" placeholder="55083" required>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" v-model="remitent_address" placeholder="Calle" required>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" v-model="remitent_number_out" placeholder="Numero Exterior" required>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" v-model="remitent_number_int" placeholder="Numero Interior">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" v-model="remitent_district" placeholder="El mirador" required>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" v-model="remitent_reference" placeholder="Entre que calles" required>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" v-model="remitent_detail" placeholder="(Color de fachada y puerta)" required>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                      <div class="col">
                          <div class="btn-group float-right" role="group" aria-label="Opciones">
                            <button @click="abrirModal('directorio')" class="btn btn-outline-dark">Directorio</button>
                ...
                <section id="inputs-destino">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_mail"  placeholder="email@example.com">
                     </div>
                  </div>
                  <!-- ------------------------------------------------------------------------>
                  <div class="form-group row">
                     ...
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_company"  placeholder="Negocio">
                     </div>
                  </div>
                  <div class="form-group row">
                     <label destinatary_for="destinatary_name" class="col-sm-3 col-form-label">Nombre<span class="text-danger small">*</span></label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_name"  placeholder="Mr. Juan Valdez" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="destinatary_rfc" class="col-sm-3 col-form-label">RFC</label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_rfc"  placeholder="RFC o Razon Social">
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="destinatary_department" class="col-sm-3 col-form-label">Departamento</label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_department"  placeholder="Atecnción o departamento">
                     </div>
                  </div>
                  <div class="form-group row">
                     <label destinatary_for="phone" class="col-sm-3 col-form-label">Telefono<span class="text-danger small">*</span></label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_phone"  placeholder="7775985421" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="destinatary_movil" class="col-sm-3 col-form-label">Movil<span class="text-danger small">*</span></label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_movil"  placeholder="7775985421" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="destinatary_zip_code" class="col-sm-3 col-form-label">CP<span class="text-danger small">*</span></label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_zip_code"  placeholder="55083" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="destinatary_address" class="col-sm-3 col-form-label">Calle<span class="text-danger small">*</span></label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_address"  placeholder="Calle" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="destinatary_number_out" class="col-sm-3 col-form-label">No Exterior<span class="text-danger small">*</span></label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_number_out"  placeholder="Numero Exterior" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="destinatary_number_int" class="col-sm-3 col-form-label">No Interior</label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_number_int"  placeholder="Numero Interior">
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="destinatary_district" class="col-sm-3 col-form-label">Colonia<span class="text-danger small">*</span></label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_district"  placeholder="El mirador" required>
                     </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label" for="select_estado">Estado</label>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_reference"  placeholder="Entre que calles" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="destinatary_detail" class="col-sm-3 col-form-label">Detalles<span class="text-danger small">*</span></label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_detail"  placeholder="(Color de fachada y puerta)" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="destinatary_weight" class="col-sm-3 col-form-label">Peso<span class="text-danger small">*</span></label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_weight" placeholder="(Color de fachada y puerta)" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="destinatary_unit_measure" class="col-sm-3 col-form-label">Unidad de Medida<span class="text-danger small">*</span></label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" v-model="destinatary_unit_measure" placeholder="Caja, bolsa, sobre, paquete, etc." required>
                     </div>
                  </div>
                </section><!--./inputs-destino-->

                 <button class="btn btn-info" @click="modalPaquetes()">Paquetes</button>
              </div>
            </div>
         </div><!--.col-6-->
     </div><!--.row-->
      ...
      <div class="modal-dialog modal-primary modal-lg" role="document">
        <div class="modal-content">
                ...
                <table class="table table-bordered table-striped table-sm">
                  ...
                  <tbody>
                    <tr v-for="dstn in arrayDirectorioClientes " :key="dstn.id">
                      ...
                      <td><button class="btn btn-primary btn-sm" @click="seleccionarDestino(dstn)"><i class="fa fa-check"></i></button></td>
                    </tr>
                  </tbody>
                </table>
                <nav>
            ...
            <div v-else-if="tipoAccion==3">
              ...
              <div class="form-row">
                <div class="col">
                  ...
                  <input type="nomber" min="0" step="any" class="form-control" v-model="paquete_longitud" placeholder="Longitud">
                </div>
                <div class="col">
                  <label for="paquete_ancho">Ancho</label>
                  <input type="nomber" min="0" step="any" class="form-control" v-model="paquete_ancho" placeholder="Ancho">
                </div>
                <div class="col">
                  <label for="paquete_altura">Altura</label>
                  <input type="nomber" min="0" step="any" class="form-control" v-model="paquete_altura" placeholder="Altura">
                </div>
              </div>
            </div>
            <!--./MODAL PARA PAQUETES -->
          ...
          <div class="modal-footer">
              ...
              <button type="button" v-if="tipoAccion==2" class="btn btn-primary" @click="agregarPaquete()">Actualizar</button>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
...
<script>
    export default {
        ...
        methods:{
            ...
            seleccionarDestino(destinatario=[]){
               let me = this
               ...
               me.destinatary_weight= '';
               me.destinatary_unit_measure= '';
               me.modal=0;
               me.tituloModal='';
            },
            ...
            validarDatosEnvio(){
              ...
              if (!this.destinatary_weight) this.errorMostrarMsj.push('El peso del destinatario no puede estar vacio ');
              if (!this.destinatary_unit_measure) this.errorMostrarMsj.push('La unidad de medida del destinatario no puede estar vacio ');
            ...
            storeEnvio(){
                ...
                axios.post('/customer/shipment/store',{
                  ...
                  'destinatary_weight':me.destinatary_weight,
                  'destinatary_unit_measure':me.destinatary_unit_measure,
